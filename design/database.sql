...
CREATE TABLE `contest` (
  ...
  `status` tinyint(1) unsigned NOT NULL COMMENT '0关闭 1开启 2已结束',
...
INSERT INTO `contest` VALUES (3,'这是一个比赛',14,'检测大家的技巧','我来给大家信息接发接飞机发哦飞啊飞阿尔及发级啊诶发骄傲二维if就as诶飞',150000000000000,150000000000100,5,NULL,0,1,0,1510403394474),(4,'这是一个比赛',14,'检测大家的技巧','我来给大家信息接发接飞机发哦飞啊飞阿尔及发级啊诶发骄傲二维if就as诶飞',150000000000000,150000000000100,5,'1',0,1,0,1510403786772),(5,'这是一个比赛',14,'检测大家的技巧','我来给大家信息接发接飞机发哦飞啊飞阿尔及发级啊诶发骄傲二维if就as诶飞',150000000000000,150000000000100,5,'1',0,1,0,1510464222315),(6,'这是一个牛逼的比赛',14,'检测大家的技巧','我来给大家信息接发接飞机发哦飞啊飞阿尔及发级啊诶发骄傲二维if就as诶飞',150000000000000,150000000000100,5,'1',0,0,1,1510832002472),(7,'aef',35,'aef','aef',1512313440000,1516118400000,NULL,NULL,0,0,0,1512293375827),(8,'再来试试11',35,'哈哈哈','哈哈',1512316800000,1515427200000,1512238500000,'123456',0,1,0,1512295979305);
...
INSERT INTO `tags` VALUES ('C++',2),('java',3),('考点一',3),('链表',2);
...
-- Dump completed on 2017-12-03 21:07:30
